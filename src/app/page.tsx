      ...
      <div className={styles.container}>
        ...
        <div className={styles.heroSection}>
          <div className={styles.heroContent}>
            ...
            <p className={styles.subheading}>Discover amazing products from sellers around the world</p>
            <Link href="/products">
        ...
        <div className={styles.card}>
          ...
          <p className={styles.text}>Discover our handpicked selection of top products from trusted sellers.</p>
        ...
        <div className={styles.card}>
          ...
          <p className={styles.text}>Our marketplace connects buyers with sellers in a seamless experience.</p>
        ...
        <div className={styles.testimonialSection}>
          ...
          <div className={styles.testimonials}>
            <div className={styles.testimonial}>
              <p className={styles.quote}>"This marketplace has transformed how I shop online. The variety of products is amazing!"</p>
              <div className={styles.author}>- Sarah J.</div>
            </div>
            <div className={styles.testimonial}>
              <p className={styles.quote}>"As a seller, I've been able to reach customers I never would have found otherwise."</p>
